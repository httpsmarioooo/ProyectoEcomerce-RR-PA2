...
document.getElementById ("valor4").addEventListener("mouseover",function () {
    document.getElementById ("respuesta4").innerHTML= "<strong> Inclusion: </strong>Permitimos un espacio y una plataforma segura para las personas dentro del espectro autista. Diseñada especialmente para ser amigable con la mente y personalidad autista."
})
